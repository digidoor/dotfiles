...
local test = true  
colors = { { title = 'LIGHTBLUE', color1 = '990000', color2 = "#009977" } }
return
{
	{
		...
		-- enabled = false,
		lazy = false,
		config = function() vim.cmd.colorscheme("tokyonight") end, -- the parens around tokyonight are unnecessary
		priority = 1000,
		opts = {},
	},
	{ -- color = "#009988"
    	...
    	opts = { -- set to setup table
			filetypes = {
				...
				-- html.mode = "foreground", --! THIS DOESN'T WORK. TODO: Figure out why.
			},
		},
	},
}
