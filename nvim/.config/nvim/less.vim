...
map H h
fun! s:Help()
  echo "f         One page forward          b         One page backward"
...
map <script> <C-V> :call <SID>NextPage()<CR><SID>L
map f :call <SID>NextPage()<CR><SID>L
map <C-F> :call <SID>NextPage()<CR><SID>L
map <PageDown> :call <SID>NextPage()<CR><SID>L
map <kPageDown> :call <SID>NextPage()<CR><SID>L
map <S-Down> :call <SID>NextPage()<CR><SID>L
